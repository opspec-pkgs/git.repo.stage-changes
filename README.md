[![build](https://github.com/opspec-pkgs/git.repo.stage-changes/actions/workflows/build.yml/badge.svg)](https://github.com/opspec-pkgs/git.repo.stage-changes/actions/workflows/build.yml)
