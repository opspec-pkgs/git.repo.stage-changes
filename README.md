[![Build Status](https://github.com/opspec-pkgs/git.repo.stage-changes/workflows/build/badge.svg?branch=main)](https://github.com/opspec-pkgs/git.repo.stage-changes/actions?query=workflow%3Abuild+branch%3Amain)
